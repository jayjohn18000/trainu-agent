...
const tiers = [
  {
    ...
    tier: "starter",
    description: "Core CRM - Seamless Messaging + Social Media Management ",
    popular: false,
    features: [
...
const faqs = [
  {
    ...
    answer:
      "All plans are billed monthly with no long-term contracts. You can upgrade, downgrade, or cancel anytime. We offer a 14-day free trial on all plans with no credit card required.",
  },
  {
    question: "What counts as an SMS message?",
    answer:
      "Standard SMS messages are 160 characters. Messages longer than 160 characters count as multiple segments. MMS (images/videos) count as 3 message credits. Additional messages beyond your plan limit cost $0.015 each.",
  },
  {
    question: "Can I upgrade or downgrade plans?",
    answer:
      "Yes! You can change plans anytime from your account settings. Upgrades take effect immediately with prorated billing. Downgrades take effect at the next billing cycle.",
  },
  {
    question: "How does the GoHighLevel integration work?",
    answer:
      "TrainU connects to your GHL account via OAuth in under 10 minutes. We sync contacts bidirectionally, push AI-drafted messages to GHL workflows, and pull engagement data for risk scoring. No data migration needed.",
  },
  {
    question: "What happens if I exceed my client or SMS limits?",
    answer:
      "For client limits, we'll notify you and give you 7 days to upgrade before pausing new client adds. For SMS, we'll send you an alert at 80% usage. Overages are billed at $0.015 per message.",
  },
  {
    question: "Is there a setup fee?",
    answer:
      "No setup fees ever. We guide you through onboarding with video tutorials and live chat support. Most trainers are fully set up within 30 minutes.",
  },
  {
    question: "Do you offer discounts for annual plans?",
    answer:
      "Yes! Pay annually and save 20% (2 months free). Contact our sales team for multi-year or multi-location discounts.",
  },
  {
    question: "What if I need more than 15,000 SMS messages per month?",
    answer:
      "Pro plan users can purchase additional SMS bundles at discounted rates. Contact sales for custom enterprise pricing if you regularly exceed 50,000 messages/month.",
  },
  {
    question: "How does automated onboarding work?",
    answer:
      "After you select your plan and complete payment through our secure GHL checkout, our system automatically creates your sub-account, installs snapshots with pre-built automations and tags, sends you a welcome email/SMS with login credentials, and provisions all SaaS features. When you log in for the first time at app.trainu.us, you'll see an interactive walkthrough and setup checklist. Most trainers are fully operational in under 10 minutes with zero manual configuration required.",
  },
  {
    question: "Is the GHL integration included in all plans?",
    answer:
      "Yes! All plans include bi-directional sync with GoHighLevel. Your contacts, messages, and engagement data sync automatically. Professional and Growth+ plans unlock additional GHL features like advanced workflows and (Growth+ only) full GHL suite access including funnels, pipelines, and websites.",
  },
  {
    question: "What's included in the messaging credits?",
    answer:
      "Each plan includes monthly messaging credits that roll over for up to 3 months: Starter gets $10, Professional gets $25, and Growth+ gets $100. These credits cover SMS, MMS, email, and automations. Standard SMS costs ~$0.01-0.015 per message. Unused credits roll over, so you never lose value.",
  },
  {
    question: "How does the GHL checkout work?",
    answer:
      "When you click 'Get Started,' you'll be redirected to our secure GHL order form where Stripe processes your payment. GHL automatically handles billing automation, failed payment recovery, and account lockouts if needed. After payment, our system provisions your account instantly and sends you login credentials.",
  },
];
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-4">
                    From the moment you subscribe, our system handles everything: sub-account creation, snapshot
                    installation, welcome messages, and dashboard setup. You'll be retaining clients in under 10 minutes
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Browse features and choose the plan that fits your needs
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Redirected to secure checkout, Stripe processes payment
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Sub-account created, snapshots installed, welcome messages sent
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Access your credentials and login to your new account
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Interactive tour shows you key features on first login
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      All features ready, CRM automations active, AI learning begins
                    </p>
                  </div>
                </div>
              </div>
            ...
            <Card className="max-w-4xl mx-auto p-12 backdrop-blur-xl bg-card/90 border-primary/20 shadow-glow">
              <div className="text-center">
                ...
                <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                  Large studios, multi-location businesses, and enterprises with unique needs can work with our sales
                  team for custom pricing and features.
                </p>
